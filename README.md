...
- **Penyimpanan Lokal (LocalStorage)**: Riwayat tersimpan permanen di browser pengguna tanpa perlu database eksternal.
...
6. Klik **Simpan ke Riwayat** atau **Cetak Berita Acara Kas**.
